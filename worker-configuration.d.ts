/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv ./worker-configuration.d.ts` (hash: 18d8934f56e38ec67cce9a0aebe11749)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SITE_URL" | "SESSION_SECRET" | "INGEST_SECRET" | "EMAIL_FROM" | "ADMIN_PASSWORD_HASH">> {}
}
